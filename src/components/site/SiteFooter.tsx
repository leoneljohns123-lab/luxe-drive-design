  ...
  return (
    <footer className="border-t border-border bg-surface">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 md:grid-cols-[1.4fr_1fr_1fr] lg:px-8">
        <div className="min-w-0">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-display text-base font-bold">Aurum Drive</span>
          </div>
          <p className="mt-4 max-w-sm text-sm leading-relaxed text-muted-foreground">
            Premium vehicle hire with transparent pricing, meticulous preparation and around-the-clock
            support. Delivered wherever you are.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2.5 text-sm text-muted-foreground">
            <li className="flex items-start gap-2">
              ...
              <a href="tel:+254700123456" className="hover:text-gold">
                +254 700 123 456
              </a>
            </li>
            <li className="flex items-start gap-2">
              <Mail className="mt-0.5 size-4 shrink-0 text-gold" />
              <a href="mailto:hello@aurumdrive.co" className="hover:text-gold">
                hello@aurumdrive.co
              </a>
            </li>
            <li className="flex items-start gap-2">
      ...
      <div className="border-t border-border px-4 py-6 text-center text-xs text-muted-foreground sm:px-6 lg:px-8">
        © {new Date().getFullYear()} Aurum Drive. All rights reserved.
      </div>
    </footer>
  );
}
